...
class TuringMachineSimulator:
    def __init__(self, root):
        ...
        self.head_position = self.search_head()
        
        self.label_head.place(x=self.head_position, y=38)  # Posición inicial de la cabeza
    ...
    def position_head_sycronized(self, x):
        self.cell_coordinates[x]
        print(self.cell_coordinates[x])
    ...
    def auto_step(self):
        ...
        self.label_head.place(x=self.head_position +36 * self.head_position, y=38)

        # Programa el siguiente paso automático
        self.root.after(self.step_delay, self.auto_step)

        self.cell_coordinates = [cell.winfo_x() for cell in self.cells]
        self.position_head_sycronized(self.head_position)
